...
public class MarcoWeatherOpenHelper extends SQLiteOpenHelper {
	 ...
	 * County表建表语句
	 */
	public static final String CREAT_COUNTRY = "create table County ("
			+ "id integer primary key autoincrement," + "county_name text,"
			+ "county_code text)" + "city_id integer)";

	public MarcoWeatherOpenHelper(Context context, String name,
